                    ...
                    <div>
                        {formSubmitted ? (
                            <div className="bg-green-50 p-6 rounded-lg border border-green-200">
                                ...
                                <h2 className="text-2xl font-semibold text-center text-green-800 mb-2">Message Sent!</h2>
                    ...
                    <div>
                        ...
                        <div className="bg-gray-50 p-6 rounded-lg">
                            ...
                            <div className="flex space-x-4 mb-6">
                                <a href="#" className="bg-[#e85c2c] text-white w-10 h-10 rounded-full flex items-center justify-center hover:bg-[#d04b1c] transition-colors">
                            ...
                            <div className="bg-white rounded-lg overflow-hidden">
                                <iframe
                                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3022.9663095989537!2d-74.0059418846361!3d40.71277737933168!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNDDCsDQyJzQ2LjAiTiA3NMKwMDAnMTguMCJX!5e0!3m2!1sen!2sus!4v1627309371661!5m2!1sen!2sus"
                                    width="100%"
                                    height="200"
                                    style={{ border: 0 }}
                                    allowFullScreen
