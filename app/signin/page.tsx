    ...
    <div className="flex min-h-screen">
      ...
      <div className="w-full md:w-1/2 bg-[#f8f5eb] p-8 md:p-16 flex flex-col justify-center">
        <div className="max-w-md mx-auto">
          ...
          <h1 className="text-4xl font-bold text-center text-gray-800 mb-4">Sign In</h1>
          ...
          <form className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <Link href="/forgot-password" className="text-sm text-[#e85c2c] hover:underline">
                Forgot password?
              </Link>
            </div>

            <Button className="w-full bg-[#e85c2c] hover:bg-[#d04a1d] text-white">Sign In</Button>
            ...
            <div className="text-center mt-6">
              <p className="text-sm text-gray-600">
                ...
                <Link href="/signup" className="text-[#e85c2c] hover:underline font-medium">
                  Sign up
                </Link>
              </p>
            </div>
