...
export function PaletteIcon({ className = "w-6 h-6" }: IconProps) {
    return (
        ...
        >
            ...
            <circle cx="6.5" cy="14.5" r="2.5"></circle>
...
export function OrderIcon({ className = "w-6 h-6" }: IconProps) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
...
export function InventoryIcon({ className = "w-6 h-6" }: IconProps) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
...
export function LoyaltyIcon({ className = "w-6 h-6" }: IconProps) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
...
export function MarketingIcon({ className = "w-6 h-6" }: IconProps) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
