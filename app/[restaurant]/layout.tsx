...
import { RestaurantThemeProvider, useRestaurantTheme } from "@/context/restaurant-theme-context";
...
function RestaurantLayoutContent({
    ...
    return (
        <div className="min-h-screen"
            ...
            {/* Footer */}
            <footer style={{ backgroundColor: secondaryColor }} className="border-t border-gray-200 pt-10 pb-5">
